...
export const DOCUMENTATIONSPOT = [
    {
        ...
        title:'PHOTO DOCUMENTATION VISUAL',
        description:`${siteNameCamel}’s online platform gives your team instant access to a complete photographic record of your construction project anytime, anywhere. All photos of your project are available in inspection-grade detail, and indexed according to your project plans by location and date.`
    },
    {
        image:'https://res.cloudinary.com/dpyl8tyll/image/upload/v1655377065/Igle/general/home_eoxfsl.webp',
        title:'PROFESSIONAL CONSTRUCTION PHOTOGRAPHY SERVICE',
        description:`We only use professional construction photographers, experienced in navigating construction job sites, so our customers get quality images without having any of their work activities disrupted.`
    }
]
...
export const DOCUMENTATIONOPTIONS = [
    {
        ...
        descTitle:'Event-driven shoots used to create a complete photographic record of your construction site at critical milestones.',
        descDetailList: [
